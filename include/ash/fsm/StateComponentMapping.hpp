...
#include "ash/fsm/EntityState.hpp"
#include "ash/fsm/IComponentProvider.hpp"
#include "ash/fsm/ComponentInstanceProvider.hpp"
...
class StateComponentMapping
{
    public:
        ...
        /**
         * Maps through to the add method of the EntityState that this mapping belongs to so that a fluent interface can
         * be used when configuring entity states.
         *
