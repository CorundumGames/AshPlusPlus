    ...
    namespace fsm {
        ...
        class StateComponentMapping
        {
            public:
                 ...
                 * @return This ComponentMapping, so more modifications can be applied
                 */
                StateComponentMapping const& withMethod(DynamicComponentProviderClosure<C> method) {
                    this->setProvider(make_shared<IComponentProvider<C>>(DynamicComponentProvider<C>(method)));
                    return *this;
                }
