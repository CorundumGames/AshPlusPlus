    ...
    namespace core {
        class Engine
        {
            public:
                ...
                /**
                 * Dispatched when the update loop ends. If you want to add and remove systems from the engine it is
                 * usually best not to do so during the update loop. To avoid this you can listen for this signal and
                 * make the change when the signal is dispatched.
                 */
            ...
            private:
                ...
                void componentAdded(const Entity& entity, const type_info& type);
        };
    }
}
